  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        "background-color2": "var(--background-color2)",
        "background-color3": "var(--background-color3)",
        "background-color4": "var(--background-color4)",
        "text-color": "var(--text-color)",
        "primary-color": "var(--primary-color)",
        "primary-color2": "var(--primary-color2)",
        "primary-color1": "var(--primary-color1)",
        "desc-color": "var(--desc-color)",
        "desc-color1": "var(--desc-color)",
        ...
        "secondary-color-light": "rgb(var(--secondary-color-light))",
