      ...
      <div className="flex flex-col gap-2 relative">
        ...
        <div className="relative flex gap-2">
          ...
          {dropdownOpen && (
            <div
              ref={dropdownRef}
              className="absolute z-10 bg-white border border-light-gray rounded-xl shadow-lg w-full md:w-72 max-h-80 overflow-y-auto flex flex-col gap-1 p-3 top-full mt-2"
            >
              {/* Search Bar */}
              <input
                type="text"
                ...
                placeholder="Search"
                className="w-full px-3 py-2 border border-light-gray rounded-md text-lg placeholder:text-lg placeholder:font-medium placeholder:text-placeholder-gray focus:outline-none"
              />
