  ...
  return (
    <Document>
      ...
      >
        ...
        {/* Pharmacy Invoice and Patient Details */}
        <View
          style={{
            flexDirection: "row",
        ...
        >
          <View style={{ width: "45%" }}>
            ...
            >
              ...
              <Text style={{ color: "#312D2D" }}>{invoice?.invoice_date}</Text>
            </View>
            <View
              style={{
                display: "flex",
            ...
            >
              ...
              <Text style={{ color: "#312D2D" }}>{invoice?.issue_date}</Text>
            </View>
            <View
              style={{
                display: "flex",
          ...
          <View style={{ width: "30%" }}>
            ...
            <Text style={{ marginBottom: 8, color: "#312D2D" }}>
              {patient?.date_of_birth}
            </Text>
            <Text style={{ marginBottom: 8, color: "#969696" }}>
              {patient?.email}
            </Text>
            <Text style={{ marginBottom: 8, color: "#969696" }}>
              {patient?.address}
        ...
        <View style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          ...
          >
            <Text style={{ fontWeight: "extrabold" }}>
              Tax: Vat ({totals?.tax.vat_rate}%)
            </Text>
            <Text style={{ fontWeight: "extrabold" }}>
              ${totals?.tax.vat_amount}
            </Text>
          </View>
